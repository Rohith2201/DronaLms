...
export class ManageContentComponent implements OnInit, OnDestroy {
  ...
  openModuleDialog(module?: any): void {
    // TODO: Implement module dialog
    console.log('Open module dialog', module);
  }

  openLessonDialog(moduleId: string, lesson?: any): void {
    // TODO: Implement lesson dialog
    console.log('Open lesson dialog', moduleId, lesson);
  }
  ...
  openQuizDialog(quiz?: any): void {
    ...
    console.log('Open quiz dialog', quiz);
    this.snackBar.open('Quiz dialog coming soon', 'Close', { duration: 2000 });
  }

  manageQuestions(quizId: string): void {
    // TODO: Navigate to question management
    console.log('Manage questions', quizId);
    this.snackBar.open('Question management coming soon', 'Close', { duration: 2000 });
  }
